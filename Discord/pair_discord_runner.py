...
def main():
	while True:
		os.system('python Discord/pair_discord.py ' + args.sub_name)
		time.sleep(10)

time.sleep(3)
ps_output = [x for x in os.popen('ps -ef | grep \&\&\ python\ Discord/pair_discord_runner.py\ ' + args.sub_name).read().splitlines() if 'grep' not in x]
