...
requests.post(request_url + "/add-swap/", {'sub_name': args.sub_name.lower(), 'platform': args.platform.lower(), 'username': args.username.lower(), 'swap_text': args.swap_text.lower()})
